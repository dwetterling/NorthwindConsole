...
{
    public partial class NWConsole_48_DJWContext : DbContext
    {
        public NWConsole_48_DJWContext()
        {
        }

        public NWConsole_48_DJWContext(DbContextOptions<NWConsole_48_DJWContext> options)
            : base(options)
        {
        }
